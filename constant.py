...
Check https://github.com/genshin-discord/genshinbot/wiki/GenshinBot-registration-help for more detailed steps'''
...
name_map = {'神里绫华': 'Kamisato Ayaka', '迪卢克': 'Diluc', '温迪': 'Venti', '可莉': 'Klee', '钟离': 'Zhongli', '达达利亚': 'Tartaglia',
            ...
            '雷电将军': 'Raiden Shogun', '珊瑚宫心海': 'Sangonomiya Kokomi', '八重神子': 'Yae Miko', '夜兰': 'Yelan', '申鹤': 'Shenhe',
            '香菱': 'Xiangling', '行秋': 'Xingqiu', '菲谢尔': 'Fischl', '班尼特': 'Bennett', '罗莎莉亚': 'Rosaria',
            '九条裟罗': 'Kujou Sara', '荒泷一斗': 'Arataki Itto', '迪奥娜': 'Diona', '砂糖': 'Sucrose', '五郎': 'Gorou', '雷泽': 'Razor',
            '宵宫': 'Yoimiya', '旅行者': 'Traveler', '芭芭拉': 'Barbara', '凝光': 'Ningguang', '刻晴': 'Keqing', '丽莎': 'Lisa',
